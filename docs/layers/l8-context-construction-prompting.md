...
| [DollhouseMCP personas and skills](../studies/dollhouse-public-stack-mapping.md#dollhousemcp) | Public Dollhouse Research examples where reusable personas, skills, and activation patterns shape model-facing context. | L8 context, L16 product UX |
| [Elemental Surveys](../studies/dollhouse-public-stack-mapping.md#elemental-surveys) | Applied research workflow where framing, instructions, and context assembly are part of the visible product behavior. | L8 context, L12 planning |
