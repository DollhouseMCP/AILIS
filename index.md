...
**Version 0.1** - Everything here is subject to change based on community feedback. We're not trying to create a standard—we're trying to start a useful conversation.
///

*Questions? Thoughts? We'd love to hear from you. [Start a discussion →](https://github.com/DollhouseMCP/AILIS/discussions)*
